...
int PDC_scr_open( int argc, char **argv)
{
	...
	// harvest-rogue mods: Manually set the palette
	pdc_rgbs[ 0] = RGB(0x00, 0x00, 0x00); // Black
	pdc_rgbs[ 1] = RGB(0xC0, 0x00, 0x00); // Red
	pdc_rgbs[ 2] = RGB(0x00, 0xC0, 0x00); // Green
	pdc_rgbs[ 3] = RGB(0xC0, 0xC0, 0x00); // Yellow
	pdc_rgbs[ 4] = RGB(0x00, 0x00, 0xC0); // Blue
	pdc_rgbs[ 5] = RGB(0xC0, 0x00, 0xC0); // Magenta
	pdc_rgbs[ 6] = RGB(0x00, 0xC0, 0xC0); // Cyan
	pdc_rgbs[ 7] = RGB(0xC0, 0xC0, 0xC0); // Silver
	pdc_rgbs[ 8] = RGB(0x40, 0x40, 0x40); // Gray
	pdc_rgbs[ 9] = RGB(0xFF, 0x00, 0x00); // Bright Red
	pdc_rgbs[10] = RGB(0x00, 0xFF, 0x00); // Bright Green
	pdc_rgbs[11] = RGB(0xFF, 0xFF, 0x00); // Bright Yellow
	pdc_rgbs[12] = RGB(0x00, 0x00, 0xFF); // Bright Blue
	pdc_rgbs[13] = RGB(0xFF, 0x00, 0xFF); // Bright Magenta
	pdc_rgbs[14] = RGB(0x00, 0xFF, 0xFF); // Bright Cyan
	pdc_rgbs[15] = RGB(0xFF, 0xFF, 0xFF); // White
